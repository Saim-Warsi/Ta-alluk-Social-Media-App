            ...
            <div className="flex mt-4 gap-2">
             ...
             <div className="flex mt-4 gap-2">
                ...
                onClick={()=>toast.promise(handleCreateStory(),{
                 ...
                 className="flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-yellow-500 hover:bg-yellow-400 active:scale-95 transition cursor-pointer">
