                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                            Profile Picture
                            <input type="file" id="profile_picture" hidden accept='image/*'
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        ...
                        >
                            Cover Photo
                            <input type="file" id="cover_photo" hidden accept='image/*'
                            className='w-full p-3 border border-gray-200 rounded-lg'
                            ...
                            <div className='group/cover relative'>
                                ...
                                className='w-80 h-40 rounded-lg bg-amber-500 hover:bg-yellow-500 object-cover mt-2'
                                />
                    ...
                    <div>
                        ...
                        <input type="text"  id="" className='w-full p-3 border border-gray-200 rounded-lg'
                    ...
                    {/* bio */}
                      <div>
                        ...
                        <textarea rows={3}  id="" className='w-full p-3 border border-gray-200 rounded-lg'
                    ...
                    <div className="flex justify-end space-x-3 pt-6">
                        ...
                        <button
                        type='submit'
                        className='px-4 py-2 bg-amber-500 hover:bg-yellow-500 text-white rounded-lg transition-colors cursor-pointer'
                        >Save</button>
                    </div>
                </form>
            </div>
