...
const Feed = () => {
  ...
  return !loading ? (
    <div className='ml-10 sm:ml-15 lg:ml-60 xl:ml-72 2xl:ml-0 w-auto bg-gray-50 overflow-y-scroll no-scrollbar py-10 xl:pr-5 flex items-start justify-center xl:gap-8'>
        {/* stories and posts */}
        <div className="">
          <StoriesBar />
